...
* You can quickly create players as desired using the following command:
  ...
  `python example_project/manage.py generate_players 2 5 dumb_avatar.py`

  This creates 5 new users in level 2 with password `123`, and creates for each user an avatar that runs the code in `dumb_avatar.py`
