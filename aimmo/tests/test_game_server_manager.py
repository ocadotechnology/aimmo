...
def test_create_game_server_allocation(game_server_manager, game_id, game_data, monkeypatch):
    ...
    game_server_manager.create_game_server_allocation(game_id=game_id, game_data=game_data)
