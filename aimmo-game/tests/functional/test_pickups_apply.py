...
class TestGame(object):
    def __init__(self, settings=SETTINGS):
        ...
        self.turn_manager = SequentialTurnManager(game_state=self.game_state, end_turn_callback=lambda: None, completion_url='')


class TestEffects(TestCase):
    def test_pickups_apply(self):
        game = TestGame()
