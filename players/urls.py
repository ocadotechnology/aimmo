...
urlpatterns = [
    ...
    url(r'^api/games/(?P<id>[0-9]+)/connection_params/$', views.connection_params, name='aimmo/connection_params'),
    url(r'^api/games/(?P<id>[0-9]+)/complete/$', views.mark_game_complete, name='aimmo/complete_game'),
    url(r'^api/games/(?P<id>[0-9]+)/current_avatar/$', views.current_avatar_in_game, name='aimmo/current_avatar_in_game'),
